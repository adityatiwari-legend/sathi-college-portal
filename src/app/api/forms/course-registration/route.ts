...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ error: { message: 'Failed to fetch course registrations', details: error.message } }, { status: 500 });
  }
}
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ error: { message: 'Failed to process course registration', details: error.message } }, { status: 500 });
  }
}
